...
hstats_wcc_main <- hstats(m_wcc_main, X = dt, v = c('mat_change', 'prec_change', 'n_deposition',
...
hstats_wcc_high_biomass <- hstats(m_wcc_high_biomass, X = dt_high_biomass, v = c('mat_change', 'prec_change', 'n_deposition',
                                                    'CW_mean_species_body_mass', 'herbi_fun_div_distq1',
                                                    'n_herbi_sp_reserve', 'grazer_biomass_kgkm2', 
                                                    'browser_biomass_kgkm2', 'herbi_biomass_kgkm2', 
                                                    'fire_frequency', 'burned_area_coef'))
...
hstats_vwct_main <- hstats(m_vwct_main, X = dt, v = c('mat_change', 'prec_change', 'n_deposition',
                                                    'CW_mean_species_body_mass', 'herbi_fun_div_distq1',
                                                    'n_herbi_sp_reserve', 'grazer_biomass_kgkm2', 
                                                    'browser_biomass_kgkm2', 'herbi_biomass_kgkm2', 
                                                    'fire_frequency', 'burned_area_coef'))
...
hstats_vwct_high_biomass <- hstats(m_vwct_high_biomass, X = dt_high_biomass, v = c('mat_change', 'prec_change', 'n_deposition',
                                                                                 'CW_mean_species_body_mass', 'herbi_fun_div_distq1',
                                                                                 'n_herbi_sp_reserve', 'grazer_biomass_kgkm2', 
                                                                                 'browser_biomass_kgkm2', 'herbi_biomass_kgkm2', 
                                                                                 'fire_frequency', 'burned_area_coef'))
...
hstats_wcsdha_high_biomass <- hstats(m_wcsdha_high_biomass, X = dt_high_biomass, v = c('mat_change', 'prec_change', 'n_deposition',
                                                                                   'CW_mean_species_body_mass', 'herbi_fun_div_distq1',
                                                                                   'n_herbi_sp_reserve', 'grazer_biomass_kgkm2', 
                                                                                   'browser_biomass_kgkm2', 'herbi_biomass_kgkm2', 
                                                                                   'fire_frequency', 'burned_area_coef'))
...
hstats_wcsdkm_main <- hstats(m_wcsdkm_main, X = dt, v = c('mat_change', 'prec_change', 'n_deposition',
                                                          'CW_mean_species_body_mass', 'herbi_fun_div_distq1',
                                                          'n_herbi_sp_reserve', 'grazer_biomass_kgkm2', 
                                                          'browser_biomass_kgkm2', 'herbi_biomass_kgkm2', 
                                                          'fire_frequency', 'burned_area_coef'))
...
hstats_wcsdkm_high_biomass <- hstats(m_wcsdkm_high_biomass, X = dt_high_biomass, v = c('mat_change', 'prec_change', 'n_deposition',
                                                                                       'CW_mean_species_body_mass', 'herbi_fun_div_distq1',
                                                                                       'n_herbi_sp_reserve', 'grazer_biomass_kgkm2', 
                                                                                       'browser_biomass_kgkm2', 'herbi_biomass_kgkm2', 
                                                                                       'fire_frequency', 'burned_area_coef'))
