...
dt <- fread("data/clean_data/final_south_african_pa_data.csv") %>% 
...
future_walk(1:nrow(dt_tier),
            ...
            function(i) {
              ...
              filename_comp <- paste0("builds/plots/revision/south_african_pas_ml_results/comparison_plot_", response_tier, ".png")
              ggsave(plot = p_comp, filename = filename_comp, dpi = 600, height = 5.1, width = 13)
              ...
              filename <- paste0("builds/plots/revision/south_african_pas_ml_results/comb_plot_", response_tier, ".png")
              
              ggsave(plot = p_comb, filename = filename, dpi = 600, height = 5.1, width = 13)
