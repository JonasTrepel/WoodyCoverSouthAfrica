...
foreach.results <- foreach(i = 1:nrow(dt.tier),
                           ...
                           .combine = rbind) %dopar% {
                            ...
                            # saveRDS(final.mod, file = filename.final.mod)
                             ...
                             filename.psi <- paste0("builds/plots/july/gbm_res_sp/south_african_pas_ndep/psi_plot_", tier, ".png")
                             ...
                             ##save comb plot 
                             filename <- paste0("builds/plots/july/gbm_res_sp/south_african_pas_ndep/comb_plot_", tier, ".png")
