...
n_workers = 2 #how many cores do you want to use for models?
...
guide_subset <- "response %in% c('venter_woody_cover_trend', 'woody_cover_change') & tier %in% c('main')"
...
tier_resp <- CJ(response = responses, tier = tiers) %>% 
  mutate(terms = case_when(
    response == "woody_cover_change" ~ "'mat_coef', 'prec_coef', 'mean_prec', 'CW_mean_species_body_mass', 'herbi_fun_div_distq1', 'n_herbi_sp_reserve', 'grazer_biomass_kgkm2', 'browser_biomass_kgkm2', 'herbi_biomass_kgkm2', 'fire_frequency', 'burned_area_coef'",
    response == "venter_woody_cover_trend" ~ "'mat_coef', 'prec_coef', 'mean_prec', 'CW_mean_species_body_mass', 'herbi_fun_div_distq1', 'n_herbi_sp_reserve', 'grazer_biomass_kgkm2', 'browser_biomass_kgkm2', 'herbi_biomass_kgkm2', 'fire_frequency', 'burned_area_coef', 'spatial_predictor1'",
    response == "woody_cover_sd_ha_coef" ~ "'mat_coef', 'prec_coef', 'mean_prec', 'CW_mean_species_body_mass', 'herbi_fun_div_distq1', 'n_herbi_sp_reserve', 'grazer_biomass_kgkm2', 'browser_biomass_kgkm2', 'herbi_biomass_kgkm2', 'fire_frequency', 'burned_area_coef'",
    response == "woody_cover_sd_km_coef" ~ "'mat_coef', 'prec_coef', 'mean_prec', 'CW_mean_species_body_mass', 'herbi_fun_div_distq1', 'n_herbi_sp_reserve', 'grazer_biomass_kgkm2', 'browser_biomass_kgkm2', 'herbi_biomass_kgkm2', 'fire_frequency', 'burned_area_coef'"
  )) %>% mutate(
            ...
            function(i) {
              ...
              for(number in 1:100){
                ...
                ensemble_weights_bt <- as.data.frame(varImp(greedy_ensemble_bt)) %>%
                  ...
                  rename(weight = "varImp(greedy_ensemble_bt)")
              ...
              filename_comp <- paste0("builds/plots/revision/sensitivity/no_ndep_comparison_plot_", response_tier, ".png")
              ...
              filename <- paste0("builds/plots/revision/sensitivity/no_ndep_comb_plot_", response_tier, ".png")
