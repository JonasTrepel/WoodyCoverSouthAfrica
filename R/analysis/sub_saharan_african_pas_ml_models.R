...
future_walk(1:nrow(dt_tier),
            ...
            function(i) {
              ...
              filename_comp <- paste0("builds/plots/revision/sub_saharan_african_pas_ml_results/comparison_plot_", response_tier, ".png")
              ...
              filename <- paste0("builds/plots/revision/sub_saharan_african_pas_ml_results/comb_plot_", response_tier, ".png")
